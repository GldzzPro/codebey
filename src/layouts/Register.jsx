...
/////// controlled state change handler
    ...
    useEffect(() => {
        setErrMsg('');
    }, [user, email , firstname, lastname , pwd, matchPwd])
            ...
            {success ? (
                ...
                <section>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        />
                        <p id="fname" className={firstnameFocus && firstname && !validFirstName ? "instructions" : "offscreen"}>
                        ...
                        />
                        <p id="lname" className={lastnameFocus && lastname && !validlastname ? "instructions" : "offscreen"}>
                        ...
                        <button disabled={!validName || !validPwd || !validMatch || !validFirstName || !validemail || !validlastname ? true : false}>Sign Up</button>
                    </form>
                    <p>
